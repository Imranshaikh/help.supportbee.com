...
namespace(:campfire) do
  task :start_deployment do
    campfire_room.speak "[Deployment] #{ENV['USER']} is preparing to deploy #{application} to supportbee.com/help" 
  end

  task :after_deployment do 
    campfire_room.speak "[Deployment] #{ENV['USER']} finished deploying #{application} to supportbee.com/help" 
  end
end
namespace :deploy do
